...
mean(glm_pred == Weekly$Direction) # calculating proportion of predictions that are accurate
...
The accuracy of QDA (58.7%) is lower compared to LDA and logistic regression (62.5% for both).
...
KNN with K = 1 has the worst overall accuracy (51.1%).

**(h) Which of these methods appears to provide the best results on this data?**

Linear regression and LDA give the equal best overall accuracy.
...
```{r 11_b_factor}
# REDO THIS SECTION using geom_mosaic
